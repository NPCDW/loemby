...
- Trakt Api [https://trakt.docs.apiary.io/](https://trakt.docs.apiary.io/)
- Simkl Api [https://simkl.docs.apiary.io/](https://simkl.docs.apiary.io/)
- Yamtrack 集成（仅支持分支版本） [https://github.com/NPCDW/Yamtrack](https://github.com/NPCDW/Yamtrack)
