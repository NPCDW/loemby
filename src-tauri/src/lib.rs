...
use controller::invoke_ctl::{get_sys_info, play_video, http_forward, load_image, go_trakt_auth, open_url, updater, restart_app};
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![get_sys_info, play_video, http_forward, load_image, go_trakt_auth, open_url, updater, restart_app])
        .setup(|app| {
