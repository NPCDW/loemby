...
use controller::invoke_ctl::{get_sys_info, play_video, go_trakt_auth, go_simkl_auth, open_url, updater, restart_app, get_runtime_config, clean_emby_image_cache, clean_icon_cache, open_folder, open_file};
...
pub fn run() {
    tauri::Builder::default()
        .invoke_handler(tauri::generate_handler![
            ...
            get_sys_info, play_video, go_trakt_auth, go_simkl_auth, open_url, updater, restart_app, get_runtime_config, clean_emby_image_cache, clean_icon_cache, open_folder, open_file
        ])
        .setup(|app| {
